...
try:
    ...
    logger = logging.getLogger("ads_analyzer.facebook_routes")
    logger.exception("FacebookActor not initialized")
...
try:
    from .modules import scraper, dataset, gcs as gcs_module, workflow, campaign_analysis, local_analysis
    ...
    router.include_router(campaign_analysis.router, prefix="", tags=["ai-analysis"])
    router.include_router(local_analysis.router, prefix="", tags=["ai-analysis"])
