...
class EnhancedPDFGenerator:
    ...
    def _create_metric_card(self, label, value, icon="●"):
        ...
        card_html = f"""
        <para align="center">
            <font name="Helvetica-Bold" size=24 color="{self.brand_color.hexval()}">{icon}</font><br/>
            <font name="Helvetica-Bold" size=8 color="#64748b">{label}</font><br/>
            <font name="Helvetica-Bold" size=18 color="#1e293b">{value}</font>
        </para>
        """
    ...
    def render(self):
        ...
        score_html = f"""
        <para align="center">
            <font name="Helvetica" size=9 color="#64748b">PUNTUACIÓN GLOBAL</font><br/>
            <font name="Helvetica-Bold" size=40 color="{score_color.hexval()}">{score}</font>
            <font size=16 color="{score_color.hexval()}">/10</font><br/>
            <font name="Helvetica-Bold" size=10 color="{score_color.hexval()}">{score_label}</font>
        </para>
        """
...
ProfessionalPDFGenerator = EnhancedPDFGenerator
...
if __name__ == "__main__":
    datos_simulados = {
        "meta_info": {
            "report_title": "Auditoría de Performance: Suzuki Grand Vitara",
            "generated_date": "2025-11-20",
            "brand_tone_detected": "Corporativo Profesional"
        },
        "design_system_recommendation": {
            "primary_hex_color": "#1f4788",
            "secondary_hex_color": "#222222"
        },
        "executive_summary": {
            "overview": "El análisis forense de la cuenta publicitaria revela una dicotomía interesante. Por un lado, las métricas de 'Awareness' están superando los benchmarks de la industria en un 15%, lo que indica una fuerte recordación de marca. Sin embargo, observamos una fricción considerable en la etapa de conversión media del embudo.",
            "investment_efficiency_score": 7.8
        },
        ...
        "top_performers": [
            {
                "ad_id": "AD-001",
                "analysis_content": "Este anuncio funciona excepcionalmente bien debido a su composición visual basada en la 'Regla de los Tercios'."
            }
        ],
        "bottom_performers": [
            {
                "ad_id": "AD-005",
                "analysis_content": "El bajo rendimiento se atribuye a una disonancia cognitiva entre la imagen y el texto."
            }
        ],
        "strategic_deep_dive": {
            "visual_strategy": "Recomendamos transicionar de la fotografía estática de estudio a composiciones dinámicas en movimiento.",
            "copywriting_audit": "El enfoque actual en especificaciones técnicas es frío y racional. Sugerimos pivotar hacia beneficios emocionales.",
            "audience_resonance": "Es crucial segmentar adecuadamente la audiencia utilizando datos demográficos y comportamentales."
        },
        "actionable_roadmap": [
            "Detener inmediatamente la inversión en anuncios de bajo rendimiento.",
            "Producir 3 variaciones del anuncio ganador para realizar test A/B.",
            "Implementar etiquetas UTM granulares para tracking detallado."
        ]
    }

    generador = EnhancedPDFGenerator("Reporte_Mejorado_Test.pdf", datos_simulados)
    generador.render()